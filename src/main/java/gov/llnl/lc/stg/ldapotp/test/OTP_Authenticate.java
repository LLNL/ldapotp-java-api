 ...
 *
 */
public class OTP_Authenticate implements CommonLogger
{
  /**
   ...
   * authentication.
   * 
   * Returns "Success" or "Denied" to indicate authentication.
   * 
  ...
  public static void main(String[] args)
  {
    ...
    try
    {
      ...
      boolean authenticated = otpInt.OTP_Authenticate(uname, new String(passcode));
      System.out.println("Authentication Response: " + (authenticated ? "Success" : "Denied"));
